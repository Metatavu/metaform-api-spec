...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BadRequest', 'model/ExportTheme', 'model/ExportThemeFile', 'model/Forbidden', 'model/InternalServerError', 'model/NotFound'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BadRequest'), require('../model/ExportTheme'), require('../model/ExportThemeFile'), require('../model/Forbidden'), require('../model/InternalServerError'), require('../model/NotFound'));
  } else {
    // Browser globals (root is window)
    if (!root.MetaformApiClient) {
      root.MetaformApiClient = {};
    }
    root.MetaformApiClient.ExportThemesApi = factory(root.MetaformApiClient.ApiClient, root.MetaformApiClient.BadRequest, root.MetaformApiClient.ExportTheme, root.MetaformApiClient.ExportThemeFile, root.MetaformApiClient.Forbidden, root.MetaformApiClient.InternalServerError, root.MetaformApiClient.NotFound);
  }
}(this, function(ApiClient, BadRequest, ExportTheme, ExportThemeFile, Forbidden, InternalServerError, NotFound) {
  'use strict';
  ...
  /**
   * Constructs a new ExportThemesApi. 
   * @alias module:api/ExportThemesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    this.createExportThemeWithHttpInfo = function(realmId, payload) {
      ...
      if (payload === undefined || payload === null) {
        throw new Error("Missing the required parameter 'payload' when calling createExportTheme");
      }
    ...
    this.deleteExportThemeWithHttpInfo = function(realmId, exportThemeId) {
      ...
      // verify the required parameter 'exportThemeId' is set
      if (exportThemeId === undefined || exportThemeId === null) {
        throw new Error("Missing the required parameter 'exportThemeId' when calling deleteExportTheme");
      }
    ...
    this.findExportThemeWithHttpInfo = function(realmId, exportThemeId) {
      ...
      // verify the required parameter 'exportThemeId' is set
      if (exportThemeId === undefined || exportThemeId === null) {
        throw new Error("Missing the required parameter 'exportThemeId' when calling findExportTheme");
      }
    ...
    this.updateExportThemeWithHttpInfo = function(realmId, exportThemeId, payload) {
      ...
      // verify the required parameter 'exportThemeId' is set
      if (exportThemeId === undefined || exportThemeId === null) {
        throw new Error("Missing the required parameter 'exportThemeId' when calling updateExportTheme");
      }

      // verify the required parameter 'payload' is set
      if (payload === undefined || payload === null) {
        throw new Error("Missing the required parameter 'payload' when calling updateExportTheme");
      }
