...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MetaformApiClient.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, pathParams,
    ...
    return new Promise(function(resolve, reject) {
      request.end(function(error, response) {
        if (!_this.retrying && response && response.status === 401) {
          const ticket = getUMATicket(response);
          const authorization = request.header.Authorization;

          getRPT(authorization, ticket)
            .then((rptAccessToken) => {
              _this.authentications["bearer"].apiKey = rptAccessToken.access_token;
              _this.retrying = true;
   ...
   */
  function getUMATicket (response) {
  ...
  function getRPT(authorization, ticket) {
