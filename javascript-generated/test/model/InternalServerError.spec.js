...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetaformApiClient.InternalServerError();
  });
  ...
  describe('InternalServerError', function() {
    it('should create an instance of InternalServerError', function() {
      ...
      //var instane = new MetaformApiClient.InternalServerError();
      //expect(instance).to.be.a(MetaformApiClient.InternalServerError);
    });
